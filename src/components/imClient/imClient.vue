        ...
        <div class="imClient-inner">
            <header class="imClient-header">
                <div class="name-wrapper position-v-mid">
                    <span v-if="chatInfoEn.chatState == 'robot'">神工坊智能客服</span>
                ...
                <div class="item imClientInfo-wrapper">
                    ...
                    <article class="imClientInfo-faq-wrapper">
                        ...
                        <main class="imClientInfo-faq-main">
                            ...
                            <ul>
                                <li v-for="(faqItem, index) in faqList" :key="index" class="imClientInfo-faq-li">

                                    <a href = "#">{{faqItem.content}}</a>
...
export default {
    ...
    data() {
        return {
            ...
            faqList: [
                { title: '神工坊相关问题', content: '神工坊相关问题' },
                { title: '今天周几', content: '一些其他技术问题，比如说xxx，关于常见问题的太长的格式怎么显示' },
                { title: '今天周几', content: '一些其他技术问题，比如说xxx，关于常见问题的太长的格式怎么显示' },
                { title: '今天周几', content: '一些其他技术问题，比如说xxx，关于常见问题的太长的格式怎么显示' },
                { title: '今天周几', content: '一些其他技术问题，比如说xxx，关于常见问题的太长的格式怎么显示' },
                { title: '今天周几', content: '一些其他技术问题，比如说xxx，关于常见问题的太长的格式怎么显示' },
